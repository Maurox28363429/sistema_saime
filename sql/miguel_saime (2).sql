...
-- Tiempo de generación: 22-06-2023 a las 14:02:54
...
INSERT INTO `log_accesos` (`id`, `user_id`, `created_at`, `ip`) VALUES
(1, 1, '2023-06-22 12:32:25', '::1'),
(2, 1, '2023-06-22 12:32:41', '::1'),
(3, 1, '2023-06-22 12:34:03', '::1'),
(4, 2, '2023-06-22 12:34:22', '::1');
...
INSERT INTO `users` (`id`, `nombres`, `apellidos`, `usuario`, `password`, `codigo`, `pregunta_1`, `respuesta_1`, `created_at`, `admin`) VALUES
(1, 'admin', 'admin', 'admin', '21232f297a57a5a743894a0e4a801fc3', '123456', 'eres admin?', 'si', '2023-06-10 23:49:40', 0),
(2, 'miguel', 'miguel', 'miguel', '9eb0c9605dc81a68731f61b3e0838937', '121212', 'miguel', 'miguel', '2023-06-22 11:17:00', 1);
...
--
ALTER TABLE `log_accesos`
  ADD CONSTRAINT `log_accesos_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
